...
// Khung thread cho candidate:
// - hiển thị lịch sử theo thời gian
// - gửi phản hồi realtime tới recruiter qua websocket + REST.
    ...
    <section className="rounded-lg border border-slate-200 bg-white">
      <header className="border-b border-slate-200 px-4 py-3">
        <h2 className="text-sm font-semibold text-slate-900">
          {conversation?.nhaTuyenDungDisplayName || "Chọn cuộc trò chuyện"}
        </h2>
      ...
      <div className="p-4">
        ...
        <div className="mt-3 flex items-end gap-2">
          <textarea
            ...
            rows={2}
            placeholder="Nhập tin nhắn cho nhà tuyển dụng..."
